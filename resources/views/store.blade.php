...
<div class="row front">
        ...
        <div class="col-8">
            <h2 class="text-success">{{$store->name}}</h2> 
    ...
    <div class="col-12 pt-4">
        <hr> 
        <h3 class="text-center text-primary"> Produtos desta Loja</h3>
        <hr>
    </div>
        ...
        @empty
            <div class="col-12"> <h3 class="alert alert-warning"> Nenhum produto encontrado para esta Loja</h3> </div>
